...
class Book 
{
	private:
    	...
    	char* author;
    	int pageCount;
    	bool formatType; // true for hardcover, false for paperback
    	float* chapterPages;
    	int numChapters;
    ...
    void display() const 
	{
      ...
      // Getter methods for title, author and page count
...
int main() 
{
    ...
    // 1. Testing Default Constructor
        ...
        // 4. Testing Memory Management with Chapter Modification
